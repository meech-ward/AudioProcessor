...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  A library for processing short peices of audio.
  ...
  # Or just: s.author    = "Sam Meech-Ward"
  # s.authors            = { "Sam Meech-Ward" => "sam@meech-ward.com" }
  # s.social_media_url   = "http://twitter.com/Sam Meech-Ward"
